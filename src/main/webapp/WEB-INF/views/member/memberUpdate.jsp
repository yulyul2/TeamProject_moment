...
<head>
	...
	* 회원가입 : member.css, member.js
	...
	<link rel="stylesheet" type="text/css" href="<%=uiPath %>/css/myinfo.css" media="all" />
	...
	<script type="text/javascript" src="<%=uiPath %>/js/myinfo.js"></script>
</head>
<body>
<!-- 이미지 리사이징 처리
	* logo 이미지 제외 
...
<div id="wrap">
	...
	<header class="inner clearfix">
		<h1 class="logo">
			<!-- [Dev] 페이지 연결 : 메인 -->
			<a href="main"><img src="<%=uiPath %>/img/logo.png" alt="moment"></a>
		</h1>
		...
		<section class="main-section clearfix">
			<div class="comm-tab-wrap">
				<ul class="tab-menu">
					...
					<li class="tab-post"><a href="memberDeleteView">회원탈퇴</a></li>
				</ul>
				<form action="javascript:void(0)" method="post" name="myinfoEditFormCheck">
					<article class="edit-profile">
						<h2>프로필 사진 / 소개글 수정</h2>
						<fieldset>
							<legned class="blind">프로필 사진 / 소개글 수정</legned>
					...
					<article class="edit-account">
						...
						<fieldset class="clearfix">
							<legned class="blind">계정 정보 수정</legned>
